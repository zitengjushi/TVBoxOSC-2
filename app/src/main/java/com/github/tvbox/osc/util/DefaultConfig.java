        ...
        try {
            ...
            if(year>2022){
                for (int i=year;i>2022;i--) {
                    json3=json3+"{\"n\":\""+String.valueOf(i)+"\",\"v\":\""+String.valueOf(i)+","+String.valueOf(i)+"\"},";
                }
            }
            String  json = json1+json3+json2;
